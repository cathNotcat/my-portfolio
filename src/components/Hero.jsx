  ...
  return (
    <section id="hero" className="min-h-screen flex items-center justify-center text-center text-white">
        <div className="max-w-[75%]">
            ...
            <h3 className="text-md md:text-3xl text-white-300 mb-4">
                {heroData.title}
            </h3>
            ...
            <div className="flex gap-6 justify-center mt-4">
                ...
                <a href="https://instagram.com/catherinerosalind" target="_blank">
                    <FaInstagram className="w-8 h-8 md:w-12 md:h-12  text-white/50 hover:text-pink-500 text-3xl transition" />
                </a>

                <a href="https://linkedin.com/in/catherinerosalind" target="_blank">
                    <FaLinkedin className="w-8 h-8 md:w-12 md:h-12 text-white/50 hover:text-blue-500 text-3xl transition" />
                </a>

                <a href="mailto:your@email.com">
                    <FaEnvelope className="w-8 h-8 md:w-12 md:h-12 text-white/50 hover:text-red-400 text-3xl transition" />
                </a>

                <a href="https://github.com/cathNotcat" target="_blank">
                    <FaGithub className="w-8 h-8 md:w-12 md:h-12 text-white/50 hover:text-white text-3xl transition" />
                </a>
